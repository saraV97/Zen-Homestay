  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-between items-center mt-3 lg:mt-20 text-slate-800">
        <div className="flex justify-start border-4 border-slate-800 shadow-2xl rounded-3xl lg:mr-0 mr-5 bg-[#EFE1D1]">
          <Magnetic>
            <div
        ...
        <div
         ...
         border-4 border-black rounded-3xl overflow-hidden flex justify-between shadow-2xl"
        >
          <iframe
      ...
      <div className="flex flex-row lg:mb-14 justify-between items-center">
        ...
        ml-1 border-4 border-slate-800 rounded-3xl lg:mr-0 sm:mr-5 mr-2 bg-[#EFE1D1] shadow-2xl"
        >
      ...
      <hr className="border-yellow-100" />
      <span className="text-medium text-center mt-5 p-5 text-yellow-100">
